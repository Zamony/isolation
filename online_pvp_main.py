...
if __name__ == "__main__":
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        ...
        if command == HOST_COMMAND:
            ...
            player_a = isolation.LocalUserControlledPlayer(ui, ui.ANN_ICON, client_socket)
            player_b = isolation.RemoteUserControlledPlayer(ui, ui.BOB_ICON, client_socket)
            ...
            player_a = isolation.RemoteUserControlledPlayer(ui, ui.ANN_ICON, server_socket)
            player_b = isolation.LocalUserControlledPlayer(ui, ui.BOB_ICON, server_socket)
