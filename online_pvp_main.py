...
if __name__ == "__main__":
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        if command == HOST_COMMAND:
            ...
            player_a = isolation.LocalUserControlledPlayer(isolation.TUI.ANN_ICON, client_socket)
            player_b = isolation.RemoteUserControlledPlayer(isolation.TUI.BOB_ICON, client_socket)
            ...
            player_a = isolation.RemoteUserControlledPlayer(isolation.TUI.ANN_ICON, server_socket)
            player_b = isolation.LocalUserControlledPlayer(isolation.TUI.BOB_ICON, server_socket)
